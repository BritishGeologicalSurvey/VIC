     ...
     char **argv)
{
	...
	if (debug==1){
		printf("I have created the global data structure for AMBHAS \n");
	}
	...
	if (debug==1){
		printf("I have read in the global data for AMBHAS \n");
	}
	...
	if (debug==1){
		printf("I have created the more data structure for AMBHAS \n");
	}	

	allocate_structs(g, d, p, ts);

	if (debug==1){
		printf("I have allocated the structures for AMBHAS \n");
	}
	...
	//link AMBHAS grid with VIC data
